import { StyledBody, FlexDiv, Visor, StyledContainer, VisorText, Numbers, Theme, SwitchRadio, SwitchLabel, Switch, SwitchSelection, StyledNumber, StyledDelete, StyledEquals, StyledTextNumber, StyledTextDelete, StyledThemeNumbers, StyledBox } from './Styles.jsx'
import React, { Component, useState } from 'react';
import { Center, Text, Grid, GridItem, Box, calc } from '@chakra-ui/react'
import './app.css'
...
function App() {
  ...
  const calculate = (number) => {
    ...
    if (visorNumber === 'Error rango') {
      ...
      if (number === '=' && operator !== '0') {
        ...
        if (operator !== '0') {
          if (number !== '+' && number !== '-' && number !== 'x' && number !== '/' && number !== '=' && visorNumber.length < 17) {
            if (visorNumber === '+' || visorNumber === '-' || visorNumber === 'x' || visorNumber === '/') {
              setVisorNumber(number)
              setB(number)
            } else {
  ...
  const floatNumber = (point) => {
    if (visorNumber.length < 17)
      setVisorNumber(visorNumber + '.');
  }

  const deleteNumber = () => {
    if (visorNumber != '0' && visorNumber != 'Error' && visorNumber != 'Error rango') {
      ...
      <StyledBody tabIndex={-1} onKeyDown={handleKeyDown}>
        <StyledContainer>
          ...
          <FlexDiv>
            ...
            <Theme>
              <Text display='flex' fontWeight='bold' fontSize='xs' mr={5}>THEME</Text>
          ...
          <Numbers>
            <Grid templateColumns='repeat(4, 1fr)' gap={5}>
              ...
              <StyledNumber >
                <StyledTextNumber id='number7' onClick={() => calculate('7')}>7</StyledTextNumber>
              </StyledNumber>
              <StyledNumber>
                <StyledTextNumber id='number8' onClick={() => calculate('8')}>8</StyledTextNumber>
              </StyledNumber>
              <StyledNumber>
                <StyledTextNumber id='number9' onClick={() => calculate('9')}>9</StyledTextNumber>
              </StyledNumber>
              <StyledDelete id='numberD'>
                <StyledTextDelete onClick={() => deleteNumber()}>DEL</StyledTextDelete>
              </StyledDelete>

              <StyledNumber>
                <StyledTextNumber id='number4' onClick={() => calculate('4')}>4</StyledTextNumber>
              </StyledNumber>
              <StyledNumber>
                <StyledTextNumber id='number5' onClick={() => calculate('5')}>5</StyledTextNumber>
              </StyledNumber>
              <StyledNumber>
                <StyledTextNumber id='number6' onClick={() => calculate('6')}>6</StyledTextNumber>
              </StyledNumber>
              <StyledNumber>
                <StyledTextNumber id='number+' onClick={() => calculate('+')}>+</StyledTextNumber>
              </StyledNumber>

              <StyledNumber>
                <StyledTextNumber id='number1' onClick={() => calculate('1')}>1</StyledTextNumber>
              </StyledNumber>
              <StyledNumber>
                <StyledTextNumber id='number2' onClick={() => calculate('2')}>2</StyledTextNumber>
              </StyledNumber>
              <StyledNumber>
                <StyledTextNumber id='number3' onClick={() => calculate('3')}>3</StyledTextNumber>
              </StyledNumber>
              <StyledNumber>
                <StyledTextNumber id='number-' onClick={() => calculate('-')}>-</StyledTextNumber>
              </StyledNumber>
              ...
              <StyledNumber>
                <StyledTextNumber id='number.' onClick={() => floatNumber('.')}>.</StyledTextNumber>
              </StyledNumber>
              <StyledNumber>
                <StyledTextNumber id='number0' onClick={() => calculate('0')}>0</StyledTextNumber>
              </StyledNumber>
              <StyledNumber>
                <StyledTextNumber id='number/' onClick={() => calculate('/')}>/</StyledTextNumber>
              </StyledNumber>
              <StyledNumber>
                <StyledTextNumber id='numberx' onClick={() => calculate('x')}>x</StyledTextNumber>
              </StyledNumber>

              <StyledDelete id='numberR' colSpan={2}>
                <StyledTextDelete onClick={() => reset()}>RESET</StyledTextDelete>
              </StyledDelete>
              <StyledEquals id='number=' colSpan={2}>
                <StyledTextDelete onClick={() => calculate('=')}>=</StyledTextDelete>
              </StyledEquals>
            </Grid>
          </Numbers>
        </StyledContainer>
